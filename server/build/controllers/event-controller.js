...
var EventController = /** @class */ (function () {
    ...
    EventController.prototype.getEvent = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query("SELECT * FROM eventos WHERE id = ?", [req.params.id])];
                    case 1:
                        evento = _a.sent();
                        if (evento.length > 0)
    ...
    EventController.prototype.getEventsByCustomer = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query("SELECT * FROM eventos WHERE client_id = ?", [req.params.client_id])];
                    case 1:
                        eventos = _a.sent();
                        if (eventos.length > 0)
                            res.json(eventos);
    ...
    EventController.prototype.getEventsByProvider = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query("SELECT * FROM eventos WHERE proveedor_id = ?", [req.params.proveedor_id])];
                    case 1:
                        eventos = _a.sent();
                        if (eventos.length > 0)
                            res.json(eventos);
    ...
    EventController.prototype.updateEvent = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.default.query("UPDATE eventos SET ? WHERE id = ?", [req.body, req.params.id])];
                    case 1:
                        _a.sent();
